...
<div className="max-w-6xl mx-auto p-8 my-12">

<div className="flex flex-col md:flex-row bg-white shadow-lg rounded-lg overflow-hidden">

{/* Left section - Contact Information */}

<div className="md:w-2/5 bg-orange-700 text-white p-8">

<h2 className="text-3xl font-bold mb-6">GET IN TOUCH</h2>

<div className="h-1 w-20 bg-orange-300 mb-8"></div>

<p className="mb-8">

Have questions about our services? Need a custom quote? Our team is ready to help printers and advertisers reach their goals.
...
<p className="text-orange-100">123 Advertising Lane, Marketing Plaza, Delhi, India - 110001</p>
...
<p className="text-orange-100">+91 98765 43210 (Sales)</p>

<p className="text-orange-100">+91 98765 43211 (Support)</p>
...
<p className="text-orange-100">info@globeadvertising.com</p>

<p className="text-orange-100">support@globeadvertising.com</p>
...
<a href="#" className="bg-white text-orange-700 p-2 rounded-full hover:bg-orange-100 transition-colors">
...
<div className="h-1 w-20 bg-gray-400 mb-8"></div>
